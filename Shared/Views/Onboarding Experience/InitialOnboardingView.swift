            ...
            VStack {
                ...
                VStack(spacing: 50) {
                    ...
                    VStack(spacing: 15) {
                        ...
                        OnboardingFeature(imageName: "person.crop.circle", imageColor: Color(.systemGray), featureName: "Account", featureDescription: "Manage your MangaDex account and view all relevant stats.")
